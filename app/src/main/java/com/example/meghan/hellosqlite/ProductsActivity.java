...
public class ProductsActivity extends AppCompatActivity {
    ...
    private DatabaseManager dbManager; // used to hold data from or for SQL
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbManager = new DatabaseManager(this); //To assit in permently holding data when app goes off.
        ...
        updateQuantityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dbManager.updateQuantity(productName, newQuantity)){
                    ...
                    allProductListAdapter.changeCursor(dbManager.getCursorAll()); //unlikely to get the entire database
                } else {
        ...
        allProductsListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, final long id) { //final long id is the Id
                ...
                Cursor cursor = (Cursor) allProductListAdapter.getItem(position); //when called gonna return a cursor
                String name = cursor.getString(1); //column 1 is string name
    ...
    //reconnect as Activity restarts, to reload database
    @Override
